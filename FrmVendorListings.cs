...
namespace Edge
{
    public partial class FrmVendorListings : Form
    {
        ...
        string Source1;
        string strQryMain;
        public FrmVendorListings(string Source )
        {
            InitializeComponent();
            Source1 = Source;
        }
       ...
       public void LoadLvList(string strQ)
          ...
          if (Source1 == "STAFF")
                {
                    ...
                    if (strQ == "<ALL>")
                    {
                        str = "SELECT [Sn] AS [RefNo],IDNo, [Name] AS [Staff Name] ,Category,[TINNo],[Address],[EmailAddress] AS [Email Address] ,[Telephone] ,[BankName] AS [Bank Name],[BankAcctNo] AS [Account No],[BankCode] AS [Bank Code],[BankAddress] AS [Bank Address],[Remark],[InActive] FROM RegisterVendor WHERE Source='STAFF' ORDER BY [Name]";
                    }
                    else
                    {
                        str = "SELECT [Sn] AS [RefNo],IDNo,[Name] AS [Staff Name] ,Category,[TINNo],[Address],[EmailAddress] AS [Email Address] ,[Telephone] ,[BankName] AS [Bank Name],[BankAcctNo] AS [Account No],[BankCode] AS [Bank Code],[BankAddress] AS [Bank Address],[Remark],[InActive] FROM RegisterVendor WHERE Source='STAFF' AND " + strQ + " ORDER BY [Name]";
                    }
              ...
              if (strQ == "" || strQ == null)
                    ...
                    if (strQ == "<ALL>")
                    {
                        str = "SELECT [Sn] AS [RefNo],IDNo,[Name] AS [Vendor Name] ,Category,[TINNo],[Address],[EmailAddress] AS [Email Address] ,[Telephone] ,[BankName] AS [Bank Name],[BankAcctNo] AS [Account No],[BankCode] AS [Bank Code],[BankAddress] AS [Bank Address],[Remark],[InActive] FROM RegisterVendor WHERE Source<>'STAFF' ORDER BY [Name]";
                    }
                    else
                    {
                        str = "SELECT [Sn] AS [RefNo],IDNo,[Name] AS [Staff Name] ,Category,[TINNo],[Address],[EmailAddress] AS [Email Address] ,[Telephone] ,[BankName] AS [Bank Name],[BankAcctNo] AS [Account No],[BankCode] AS [Bank Code],[BankAddress] AS [Bank Address],[Remark],[InActive] FROM RegisterVendor WHERE Source<>'STAFF' AND " + strQ + " ORDER BY [Name]";
        ...
        {
            FrmVendorInfor ChildForm = new FrmVendorInfor("Edit", ReturnCode, Source1);
        ...
        {
            FrmVendorInfor ChildForm = new FrmVendorInfor("Delete", ReturnCode, Source1);
            ChildForm.ShowDialog();
            if (Source1 == "STAFF")
                LoadLvList(strQryMain);
            else
        ...
        {
            FrmVendorInfor ChildForm = new FrmVendorInfor("Browse", ReturnCode, Source1);
            ChildForm.ShowDialog();
            if (Source1 == "STAFF")
                LoadLvList(strQryMain);
            else
        ...
        {
            FrmVendorInfor ChildForm = new FrmVendorInfor("New", 0, Source1);
            ChildForm.ShowDialog();
            //if (Source1 == "STAFF")
                LoadLvList(strQryMain);
            //else
        ...
        private void TV_AfterSelect(object sender, TreeViewEventArgs e)
        {
            string theCond = "";
            if (Source1 == "STAFF")
                theCond = "  AND Source='STAFF'";
            else
                theCond = "  AND Source='VENDOR'";
            ...
            else
            {
                ...
                {
                    case "Bank":
                        strQry = " RegisterVendor.BankName = '" + e.Node.Text + "'" + theCond;
                        break;
                    case "Category":
                        strQry = " RegisterVendor.Category = '" + e.Node.Text + "'" + theCond;
                        break;
                    case "Region":
                        strQry = " RegisterVendor.Region = '" + e.Node.Text + "'" + theCond;
                        break;
