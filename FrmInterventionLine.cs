...
namespace Edge
{
    public partial class FrmInterventionLine : Form
    {
        private BindingSource BindingSource1 = new BindingSource();
        private SqlDataAdapter dataAdapter1 = new SqlDataAdapter();
        public FrmInterventionLine()
        {
            InitializeComponent();
        }

        private void FrmInterventionLine_Load(object sender, EventArgs e)
        {
            this.DbGrid.DataSource = BindingSource1;
            DbGrid.AutoGenerateColumns = false;
            GetData("select * from InterventionLine ORDER BY InterventionLine");
        ...
        private void cmdNew_Click(object sender, EventArgs e)
        {
            ...
            {
                DbGrid.CurrentCell = DbGrid.Rows[DbGrid.Rows.Count - 1].Cells["InterventionLine"];
            }
